...
const columns = [
  ...
  columnHelper.accessor("profit", {
    ...
    cell: (info) => {
      ...
      return (
        <span className={value > 0 ? "text-[#0082ED]" : "text-red-500"}>
    ...
    try {
      ...
      const worksheet = XLSX.utils.json_to_sheet(
        recentData.map((row, index) => ({
          ...
          "Buy Price": `₹${Number(row.buyPrice || 0).toLocaleString("en-IN", {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2,
          })}`,
          "Sold To": row.exSell?.toUpperCase() || "N/A",
          "Sell Price": `₹${Number(row.sellPrice || 0).toLocaleString("en-IN", {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2,
          })}`,
          Ticker: row.ticker?.toUpperCase() || "N/A",
          "Amount Bought": `₹${Number(row.amountBuy || 0).toLocaleString("en-IN", {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2,
          })}`,
          "Amount Sold": `₹${Number(row.amountSell || 0).toLocaleString("en-IN", {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2,
          })}`,
          Profit: `₹${Number(row.profit || 0).toLocaleString("en-IN", {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2,
          })}`,
          ...
          Traded: new Intl.DateTimeFormat("en-IN", {
            year: "numeric",
            month: "short",
            day: "numeric",
            hour: "2-digit",
