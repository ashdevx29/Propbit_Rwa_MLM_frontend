...
import KycPopup from "../Pages/KYC/KycPopUp";
...
const UserLayout = () => {
    ...
    const isKycDone = localStorage.getItem("kyc_done") === "true";

    return (
        <>
             <KycPopup isKycDone={isKycDone} />
            ...
            >
                ...
                <div
                    ...
                    ${isExpanded || isHovered ? "lg:ml-[245px]" : "lg:ml-[73px]"}
                    ${isMobileOpen ? "ml-0" : ""}`}
                >
                    <TopNav />
                    {/* Content wrapper */}
