      ...
      <div className="bg-white rounded-lg shadow-md border border-gray-200 p-4 overflow-x-auto">
        ...
        {filteredWithdrawals.length > rowsPerPage && (
          <div className="flex items-center justify-end mt-4">
            <span className="mr-4 text-[16px] font-semibold text-[#0082ED]">
            ...
            <button
              ...
              className={`px-4 py-2 mr-2 font-semibold rounded ${currentPage > 1
                  ? "bg-[linear-gradient(135deg,#0082ED_0%,#00E8A6_100%)] text-[#FFF] hover:bg-[#0e9d52]"
                  : "bg-[linear-gradient(135deg,#0082ED_0%,#00E8A6_100%)] text-[#FFF] cursor-not-allowed"
                }`}
            >
              Prev
            </button>
