...
const Withdrawals = () => {
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          if (withdrawal.status.toLowerCase() === "completed") {
            return (
              <span className="text-[#0082ED] font-bold flex items-center gap-1">
                <FaCheck /> Approved
              </span>
            );
          }
  ...
  // âœ… TanStack Table setup with all-column search
  ...
  // âœ… Export PDF using filtered rows
  ...
  // âœ… Export Excel using filtered rows
  ...
  return (
    <div className="p-4 max-w-[1260px] mx-auto">
      <h2 className="text-2xl font-bold mb-4 text-[#0082ED]">Withdrawals</h2>
      ...
      <div className="flex justify-end items-center mt-4 gap-4">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-4 py-2 rounded bg-[linear-gradient(135deg,#0082ED_0%,#00E8A6_100%)] text-white disabled:bg-gray-300 disabled:text-gray-600"
          >
            Prev
          </button>
          <button
