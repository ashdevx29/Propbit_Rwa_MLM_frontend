...
const UserManagement = () => {
  ...
  if (isLoading) {
    return (
      <div className="p-4 max-w-[1240px] mx-auto">
        <h2 className="text-2xl font-bold mb-4 text-[#0082ED]">User Management</h2>
  ...
  if (isError) {
    return (
      <div className="sm:p-4 max-w-[1240px] mx-auto">
        <h2 className="text-2xl font-bold mb-4 text-[#0082ED]">User Management</h2>
  ...
  return (
    <div className="p-2 flex-1 text-nowrap max-w-[1240px] mx-auto">
      <h2 className="text-2xl font-bold droxen-font mb-4">User Management</h2>
      <div className="mb-4 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="flex items-center w-full md:w-auto gap-2">
          ...
          <input
            ...
            className="border border-gray-300 rounded px-4 py-2 w-full max-w-xs focus:outline-none focus:ring-2 focus:ring-[#4ADD97]"
          />
          <button
      ...
      <div className="overflow-x-auto bg-white rounded shadow-md border border-gray-200 p-2 md:p-4">
        <table className="min-w-[1800px] w-full text-sm border" role="grid">
          <thead className="bg-[linear-gradient(135deg,#0082ED_0%,#00E8A6_100%)] text-[#000]">
            {table.getHeaderGroups().map((headerGroup) => (
              <tr key={headerGroup.id}>
                {headerGroup.headers.map((header) => (
                  <th key={header.id} className="p-2 border whitespace-nowrap text-[#000]">
      ...
      {editUser && (
        ...
        >
          ...
          >
            ...
            <h3 className="text-2xl font-bold mb-4 text-[#0082ED]">Edit User</h3>
                    ...
                    <div key={key} className="flex flex-col">
                      ...
                      {[
                        ...
                        <select
                          ...
                          className={`border rounded px-2 py-1 mt-1 focus:outline-none focus:ring-2 focus:ring-[#4ADD97] ${getBadgeStyle(
                            editUser[key],
                            key
                          )} ${
                            key !== "usdtWithdraw" &&
                        ...
                        <input
                          ...
                          onChange={handleEditChange}
                          disabled
                          className="border rounded px-2 py-1 mt-1 focus:outline-none focus:ring-2 focus:ring-[#4ADD97] opacity-50 cursor-not-allowed"
                          aria-label={`Edit ${formatColumnName(key)}`}
                        />
                      )}
                    </div>
      ...
      <div className="mt-6 flex md:flex-row flex-col gap-4 items-center justify-between text-sm">
        <div className="text-gray-600">
          ...
          {Math.min((pagination.pageIndex + 1) * pagination.pageSize, totalEntries)}{" "}
