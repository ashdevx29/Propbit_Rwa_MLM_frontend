      ...
      <main className="flex-1 min-h-screen p-4 md:p-6 lg:ml-5 overflow-x-hidden overflow-y-auto">
        <div className="max-w-screen-2xl mx-auto">
          <header className="mb-8">
            <h1 className="text-3xl font-bold bg-gradient-to-r from-[#4ADD97] to-[#234767] bg-clip-text text-transparent">
              Trade Management
            </h1>
          </header>
          <section className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div className="bg-white/70 backdrop-blur-lg shadow-md rounded-2xl p-6">
              <h2 className="font-semibold mb-4 text-[#0082ED]">Deposit</h2>
            ...
            <div className="bg-white/70 backdrop-blur-lg shadow-md rounded-2xl p-6">
              <h2 className="font-semibold mb-4 text-[#0082ED]">Withdrawal</h2>
            ...
            <div className="bg-white/70 backdrop-blur-lg shadow-md rounded-2xl p-6">
              <h2 className="font-semibold mb-4 text-[#0082ED]">Profit Withdrawal</h2>
