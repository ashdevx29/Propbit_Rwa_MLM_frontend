  ...
  return (
    <div className="p-4 md:p-6 max-w-full mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <h2 className="text-2xl md:text-3xl font-bold text-[#0082ED]">
        ...
        <div className="flex flex-wrap gap-3">
          <input
            ...
            className="border px-4 py-2 rounded-lg w-full sm:w-64 focus:outline-none focus:ring-2 focus:ring-[#4ADD97]"
          />
          ...
          <button
            ...
            className="bg-[linear-gradient(135deg,#0082ED_0%,#00E8A6_100%)] hover:bg-[#0d2a35] text-white px-5 py-2 rounded-lg flex items-center gap-2 transition"
          >
            <FaPlus /> Add New
          </button>
        </div>
      ...
      <div className="bg-white shadow rounded-lg overflow-hidden border">
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-[linear-gradient(135deg,#0082ED_0%,#00E8A6_100%)] text-white">
              <tr>
              ...
              {paginatedData.length === 0 ? (
                ...
                paginatedData.map((row, idx) => (
                  <tr key={row._id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-4 text-center text-[#0082ED] font-medium">
                      {row.percentage}%
                    </td>
        ...
        <div className="mt-6 flex md:flex-row flex-col gap-4 items-center justify-between text-sm">
          ...
          <div className="space-x-2 flex">
            ...
            <button
              disabled={pagination.pageIndex + 1 >= (pageCount || 1)}
              onClick={() =>
                setPagination((prev) => ({
                  ...prev,
            ...
            <button
              ...
              onClick={() =>
                setPagination((prev) => ({
                  ...prev,
                  pageIndex: Math.max((pageCount || 1) - 1, 0),
                }))
              }
              className="px-3 py-1 border text-xs rounded disabled:opacity-40"
            >
      ...
      {showUpdateModal && selectedConfig && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl p-6 md:p-8 max-w-md w-full shadow-2xl">
            <h2 className="text-xl md:text-2xl font-bold mb-6 text-[#0082ED]">
              Update Percentage
            </h2>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#4ADD97]"
                autoFocus
              />
            </div>
            ...
            <div className="flex gap-4 justify-end">
              ...
              <button
                ...
                className="px-6 py-2 bg-[linear-gradient(135deg,#0082ED_0%,#00E8A6_100%)] text-white rounded-lg hover:bg-[#0d2a35] transition"
              >
                Update Now
              </button>
            </div>
...
//                 }))
//               }
//               className="px-4 py-2 bg-[linear-gradient(135deg,#0082ED_0%,#00E8A6_100%)] text-white rounded disabled:opacity-50"
//             >
//               Next
//             </button>
//           </div>
