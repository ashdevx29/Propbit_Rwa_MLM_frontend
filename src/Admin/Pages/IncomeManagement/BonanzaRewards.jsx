  ...
  const columns = useMemo(
    () => [
      ...
      { Header: "Bonanza Income (USD)", accessor: "bonanzaIncome", Cell: ({ value }) => (value ? `$${Number(value).toFixed(2)}` : "N/A") },
      {
        ...
        accessor: "status",
        Cell: ({ value }) => (
          <div className={value === "claimed" ? "text-[#0082ED]" : "text-orange-500"}>
    ...
    <div className="p-6">
      ...
      <div className="bg-white rounded-lg shadow-md border border-gray-200 p-4 overflow-x-auto">
        <table className="min-w-full text-sm text-left text-gray-800">
          <thead className="bg-[linear-gradient(135deg,#0082ED_0%,#00E8A6_100%)] text-white uppercase">
            <tr>
              {columns.map((col) => (
      ...
      <div className="mt-6 flex md:flex-row flex-col gap-4 items-center justify-between text-sm">
        <div className="text-gray-600">
          ...
          {Math.min(currentPage * rowsPerPage, filteredRewards.length)}{" "}
