...
const SetTokenPrice = () => {
  ...
  const [lastPrices, setLastPrices] = useState({ USDT: 1.0, URWA: 0.0 });
  ...
  return (
    <div className="min-h-screen bg-[#fff] p-6 flex flex-col items-center">
      <div className="w-full max-w-xl bg-white rounded-xl shadow-lg p-8 mb-10 border border-gray-200">
        <h2 className="text-2xl font-bold text-[#0082ED] mb-6 text-center">
          Set Token Price
        </h2>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label
              ...
              className="block text-[16px] font-semibold text-[#0082ED] mb-2"
            >
              Select Currency
            </label>
            <select
          ...
          <div>
            ...
            {/* <p className="text-[14px] text-gray-500 mt-2">
              Current Price:{" "}
              <span className="font-semibold text-[#0082ED]">
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              className="bg-[linear-gradient(135deg,#0082ED_0%,#00E8A6_100%)] hover:bg-[#0e9d52] text-white font-medium px-8 py-2 rounded-lg transition-all duration-300 shadow-md disabled:opacity-50"
              disabled={isSettingPrice}
 ...
 {history.length > 0 && (
   <div className="w-full max-w-5xl bg-white rounded-xl shadow-lg p-6 border border-gray-200">
     <h2 className="text-2xl font-bold text-[#0082ED] mb-4 text-start">
     ...
     <div className="overflow-auto rounded-md">
       <table
         {...getTableProps()}
         className="min-w-full text-sm text-[#0082ED] bg-white"
       >
