      ...
      <div className="w-full max-w-lg bg-white rounded-xl shadow-lg p-8 border border-gray-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label
              htmlFor="userId"
              className="block text-[16px] font-medium text-[#0082ED] mb-1"
            >
              User ID
            </label>
            <input
          ...
          <div className="text-center">
            <button
              type="submit"
              className="w-[160px] mt-4 bg-[linear-gradient(135deg,#0082ED_0%,#00E8A6_100%)] hover:bg-[#0e9d52] text-white font-medium py-2 px-4 rounded-md transition-all duration-300 shadow-sm hover:shadow-md hover:scale-105 disabled:opacity-50 disabled:scale-100"
              disabled={isPending}
