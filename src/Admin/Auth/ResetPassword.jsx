  ...
  return (
    ...
    >
      <div className="bg-white bg-opacity-90 p-8 rounded-xl shadow-lg w-full max-w-md">
        ...
        {success && (
          <div className="mb-4 text-[#0082ED] text-sm text-center">{success}</div>
        )}
        {errors.api && (
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                value={form.newPassword}
                onChange={handleChange}
                className="w-full border border-gray-300 p-2 pr-10 rounded-md focus:outline-none focus:ring focus:ring-blue-300"
              />
      ...
      {errors.confirmPassword}
          ...
          <div className="flex justify-center">
            <button
              ...
              className="w-[100px] bg-[linear-gradient(135deg,#0082ED_0%,#00E8A6_100%)] text-white hover:opacity-90 py-2 rounded-md  transition duration-300"
            >
          ...
          <div className="text-center mt-4">
            <Link to="/admin/login" className="text-[#0082ED] hover:underline text-sm">
              Back to Login
            </Link>
          </div>
        </form>
