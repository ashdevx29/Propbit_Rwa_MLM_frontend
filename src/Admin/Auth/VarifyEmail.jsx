    ...
    return (
        ...
        >
            ...
            >
                ...
                <h2 className="text-3xl text-center font-bold text-[#0082ED] mb-6">
                    Verify Email
                </h2>

                {success && (
                    <div
                        className="text-[#0082ED] text-center text-sm mb-4"
                        role="alert"
                    >
                        {success}
                    </div>
                ...
                <form onSubmit={handleSubmit} aria-label="Email Verification Form">
                    <div className="mb-4">
                        <label
                            htmlFor="email"
                            className="block text-[#0082ED] font-semibold mb-1"
                        >
                            Email
                        </label>
                        <div className="flex items-center space-x-2">
                            <input
                                ...
                                className={`flex-1 p-2 border rounded outline-none ${errors.email ? "border-red-600" : "border-[#4ADD97]"
                                    }`}
                                value={email}
                            ...
                            <button
                                ...
                                className={`w-[100px] py-2 rounded transition text-sm ${isSendingOtp || timer > 0 || isSubmitting
                                        ...
                                        : "bg-[linear-gradient(135deg,#0082ED_0%,#00E8A6_100%)] text-white hover:bg-[#0e9d52]"
                                    }`}
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`w-full p-2 border rounded outline-none ${errors.otp ? "border-red-600" : "border-[#4ADD97]"
                                }`}
                            value={otp}
