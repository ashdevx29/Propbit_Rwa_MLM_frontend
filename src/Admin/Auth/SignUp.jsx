  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-[28px] text-center font-bold text-[#0D0D0D] mb-4">Admin Sign Up</h2>

        {success && (
          <div className="text-[#0082ED] text-center text-sm mb-4">{success}</div>
        )}
        {errors.api && (
        ...
        <div>
          <label className="block text-[#0D0D0D] font-semibold mb-1">Email</label>
          <input
            type="email"
            placeholder="Enter your email"
            className="w-full p-2 mb-1 border border-[#4ADD97] rounded outline-none"
            value={email}
          ...
          {/* <label className="block text-[#0D0D0D] font-semibold mb-1 mt-2">Password</label>
          <input
            type="password"
            ...
            disabled={isSendingOtp}
          /> */}
          <label className="block text-[#0D0D0D] font-semibold mb-1 mt-2">
  Password
</label>
...
<div className="relative">
  <input
    ...
    placeholder="Create password"
    className="w-full p-2 pr-10 mb-1 border border-[#4ADD97] rounded outline-none"
    value={password}
    onChange={(e) => setPassword(e.target.value)}
    disabled={isSendingOtp}
  />
...
{errors.role && <p className="text-red-600 text-sm mb-2">{errors.role}</p>}
          ...
          <div className="flex justify-center mt-4">
            <button
              ...
              className={`w-[120px] py-2 rounded transition ${isSendingOtp ||
                  ...
                  : "bg-[linear-gradient(135deg,#0082ED_0%,#00E8A6_100%)] text-white hover:opacity-90"
                }`}
            >
        ...
        <div className="text-right flex justify-between mt-4">
          <Link to="/admin/login" className="text-[15px] text-[#0082ED] hover:underline">
              Login
          </Link>
