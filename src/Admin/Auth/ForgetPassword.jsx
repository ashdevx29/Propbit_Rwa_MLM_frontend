  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Heading */}
        <h2 className="text-[28px] text-center font-bold text-[#0082ED] mb-6">
          Forgot Password
        </h2>
        ...
        <form onSubmit={handleSendOtp}>
          <label className="block text-[#0082ED] font-semibold mb-1">
            Email
          </label>
          <input
            type="email"
            placeholder="Enter your email"
            className="w-full p-2 mb-4 border border-[#4ADD97] rounded outline-none"
            value={email}
          ...
          <div className="flex justify-center">
            <button
              ...
              className="w-[140px] bg-[linear-gradient(135deg,#0082ED_0%,#00E8A6_100%)] text-white hover:opacity-90 py-2 rounded  transition"
            >
        ...
        <div className="text-right mt-4">
          <Link
            to="/admin/login"
            className="text-[15px] text-[#0082ED] hover:underline"
          >
            Back to Login
          </Link>
        </div>
